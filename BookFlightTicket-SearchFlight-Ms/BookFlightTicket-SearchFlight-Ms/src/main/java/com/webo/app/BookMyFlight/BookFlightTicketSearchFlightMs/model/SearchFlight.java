package com.webo.app.BookMyFlight.BookFlightTicketSearchFlightMs.model;
...
public class SearchFlight {
	...
	public String toString() {
		return "SearchFlight [flightId=" + flightId + ", flightCompany=" + flightCompany + ", flightDepartureDate="
				+ flightDepartureDate + ", flightDepartureTime=" + flightDepartureTime + ", flightArrivalDate="
				+ flightArrivalDate + ", flightArrivalTime=" + flightArrivalTime + ", flightSource=" + flightSource
				+ ", flightDestination=" + flightDestination + ", flightDuration=" + flightDuration + ", flightFare="
				+ flightFare + ", maxEconomyClassSeats=" + maxEconomyClassSeats + ", availableEconomyClassSeats="
				+ availableEconomyClassSeats + ", maxBusinessClassSeats=" + maxBusinessClassSeats
